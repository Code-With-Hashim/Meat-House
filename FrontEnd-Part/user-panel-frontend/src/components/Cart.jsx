      ...
      <>
        ...
        >
          <Image
            w="80%"
            m="auto"
            src="https://www.licious.in/img/rebranding/empty_cart_icon.png"
          />
          <Text fontStyle="bold" textAlign="center">
            Your cart awaits your next meal
          </Text>
          <Box onClick={onClose} justifyContent="center" display="flex">
            <Link _focus={false} to="/">
